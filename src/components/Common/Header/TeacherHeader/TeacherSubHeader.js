...
const TeacherSubHeader = ({
  ...
  return (
    <>
      ...
      >
        <p className={`text-white ${classes.UserName}`}>{email}</p>
      ...
      >
        ...
        <div className={`dropdown-item ${classes.DropdownItemHover}`}>
...
export default TeacherSubHeader
